...
public class CommandLineInterface {
    ...
    private final Region kclRegion;
    ...
    private CommandLineInterface(CommandLineArgs params) throws ParameterException {
        ...
        kclRegion = RegionUtils.getRegion(params.getKclSigningRegion());
    ...
    public Worker createWorker() {
        ...
        final AmazonDynamoDB kclDynamoDBClient = AmazonDynamoDBClientBuilder.standard()
                .withCredentials(credentialsProvider)
                .withEndpointConfiguration(createEndpointConfiguration(kclRegion, kclDynamodbEndpoint, AmazonDynamoDB.ENDPOINT_PREFIX))
                .build();
        ...
        streamsAdapterClient.setEndpoint(streamsEndpointConfiguration.getServiceEndpoint());
        streamsAdapterClient.setRegion(sourceRegion);
